...
export default function ContactPage() {
  ...
  const contactMethods = [
    {
      ...
      title: 'Instagram',
      subtitle: '@shy__cakes',
      description: 'Переглядайте мої останні роботи та отримуйте натхнення',
      ...
      bgColor: 'bg-gradient-to-br from-[#90e0ef]/10 to-[#48cae4]/10',
    ...
    },
    {
      ...
      bgColor: 'bg-gradient-to-br from-[#48cae4]/10 to-[#023e8a]/10',
      borderColor: 'border-[#48cae4]/30',
    },
    {
      id: 'phone',
      title: 'Телефон',
      ...
      bgColor: 'bg-gradient-to-br from-[#023e8a]/10 to-[#03045e]/10',
      borderColor: 'border-[#023e8a]/30',
    },
  ];
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#90e0ef]/10 via-white to-[#48cae4]/10">
      <PageBannerSimple
          ...
          <div className="lg:col-span-2">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Оберіть найзручніший для вас спосіб зв&apos;язку. Я завжди готова відповісти на ваші запитання та допомогти з оформленням замовлення.
              </p>
            </div>
              ...
              {contactMethods.map((method) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    { }
                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-[#90e0ef] group-hover:to-[#48cae4] transition-all duration-300">
                      {method.title}
                    </h3>
                    ...
                    { }
                    <div className="mt-4 flex items-center text-sm font-medium text-gray-500 group-hover:text-[#48cae4] transition-colors duration-300">
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-white rounded-3xl shadow-xl p-8 mb-8 border border-gray-100">
                <div className="text-center mb-6">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#90e0ef] to-[#48cae4] text-white mb-4">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Час роботи</h3>
                  <p className="text-gray-600">Я працюю для вас</p>
                </div>

                <div className="space-y-4">
                  {workingHours.map((schedule, index) => (
                    <div key={index} className="flex items-center p-4 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 hover:from-[#90e0ef]/10 hover:to-[#48cae4]/10 transition-all duration-300 group">
              ...
              { }
              <div className="bg-gradient-to-br from-[#90e0ef] to-[#48cae4] rounded-3xl shadow-xl p-8 text-white">
                <div className="text-center">
                  ...
                  <ul className="text-sm space-y-2 text-left">
                    <li className="flex items-start">
                      ...
                      <span>Замовляйте за 3-5 днів до потрібної дати</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-yellow-300 mr-2">📱</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-yellow-300 mr-2">🎂</span>
                      <span>Індивідуальні торти обговорую персонально</span>
                    </li>
                  </ul>
                </div>
              </div>
