      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white shadow-md rounded-lg p-6">
          ...
          <div>
            ...
            <p className="mb-5">Пн-Пт: <span className="font-semibold text-gray-700">9:00 – 20:00</span></p>
            <p className="mb-1">Сб-Нд: <span className="font-semibold text-gray-700">10:00 – 13:00</span></p>
          </div>
        </div>
      </div>
    </section>
