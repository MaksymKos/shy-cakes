          ...
          <div className="mb-12">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed text-center">
                Ласкаво прошу до світу SHY CAKES — місця, де кожен торт чи десерт створюється з любов’ю та турботою.
                Мене звати Аліна – я майстер, який протягом декількох років вдосконалює свої навички у кондитерському мистецтві. Постійно покращую як теоретичну, так і практичну базу своїх вмінь.
