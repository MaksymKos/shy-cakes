            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Кожен торт - це унікальна історія. Перегляньте мої останні творіння та відгуки задоволених клієнтів
                    </p>
                </div>
                ...
                <div className="relative">
                                ...
                                <div className="bg-white rounded-2xl overflow-hidden shadow-lg transition-shadow duration-300 hover:shadow-xl">
                                    {review.images.length > 0 && (
                                        <div className="aspect-square relative overflow-hidden">
                                            ...
                                            />
                                            <div className="absolute top-4 right-4 bg-gradient-to-r from-[#90e0ef] to-[#48cae4] text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Link
                                                ...
                                                className="text-[#48cae4] hover:text-[#023e8a] font-medium text-sm flex items-center transition-colors duration-200"
                                            >
                                                Детальніше
                    ...
                    { }
                    <button className="swiper-button-prev-custom absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-gradient-to-r from-[#90e0ef] to-[#48cae4] hover:from-[#48cae4] hover:to-[#023e8a] text-white w-12 h-12 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group">
                    ...
                    <button className="swiper-button-next-custom absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-gradient-to-r from-[#90e0ef] to-[#48cae4] hover:from-[#48cae4] hover:to-[#023e8a] text-white w-12 h-12 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group">
                        <svg className="w-5 h-5 group-hover:translate-x-0.5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                    </button>
